...
const static char* RRR_INST_MNEMONICS[] = {
    "add", "sub", "mul", "div", "cmp", "cmplt", "cmpeq", "cmpgt",
    "inv", "and", "or", "xor", "nop", "trap"
};

const static char* RX_INST_MNEMONICS[] = {
    "lea", "load", "store", "jump", "jumpc0", "jumpc1", "jumpf",
    "jumpt", "jal"
};

const static char* EXP_INST_MNEMONICS[] = {
    "rfi"
};
...
void sigma16_trap_end_execution(sigma16_vm_t* vm) {
    dump_cpu(&vm->cpu);
}
