...
int sigma16_vm_exec(sigma16_vm_t* vm) {
    ...
    static const void* rx_dispatch_table[] = {
        ...
        &&do_jal,       &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        ...
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op,
        &&do_bad_rx_op, &&do_bad_rx_op, &&do_bad_rx_op};
...
do_jal:
    ...
    DISPATCH();
do_bad_op:
    /* representation doesn't matter, opcode at same position for all types */
    fprintf(stderr, "invalid opcode: pc=%04x", vm->cpu.ir.rrr.pc);
    goto error;
end_hotloop:
    return 0;
error:
